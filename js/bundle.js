...
var showAlert = function showAlert(type, message) {
  hideAlert();
  console.log('here');
  var markup = "<div class = \"alert alert--".concat(type, "\">This much food could feed ").concat(message, " people!</div>");
...
var send_alert = document.getElementById('send_alert');
...
if (button) {
  document.getElementById('button').addEventListener('click', function (e) {
    ...
    var success = /*#__PURE__*/function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(pos) {
        var crd, Latitude, Longitude, res;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.prev = 5;
                _context.next = 8;
                return _axios.default.post('/api/v1/users/register', {
                  name: name,
                  email: email,
                  password: password,
...
if (send_alert) {
  document.getElementById('send_alert').addEventListener('click', /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(e) {
      var amount, address, phone, feed, res, markup;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              feed = Math.round(amount / 2.5);
              console.log(feed);
              _context2.prev = 7;
              _context2.next = 10;
              return _axios.default.post('/api/v1/users/email', {
                amount: amount,
                address: address,
                phone: phone
              });
            ...
            case 10:
              ...
              if (res.data.status === 'success') {
                markup = "<div class = \"alert alert--success\">Alert sent to all NGOs nearby!</div>";
                document.querySelector('body').insertAdjacentHTML('afterbegin', markup);
